  ...
  return (
    <>
      {product.map((products, index) => (
        <section
          key={index + product.uuid}
          className="w-[300] h-[467px] p-5 relative bg-bgItemLightColor dark:bg-bgItemDarkColor flex flex-col justify-start items-center gap-4 rounded-2xl shadow-defaultShadow"
        >
          {products.offer != 0 && (
          ...
          <div className="w-full flex flex-col justify-start items-start gap-3">
            ...
            <span
              className={
                products.amount != -1
                  ? "w-full text-right font-medium text-xl text-successPrimaryColor"
                  : "w-full text-right font-medium text-xl text-errorColor"
              }
            >
              {products.amount != -1 ? products.amount : "فعلا موجود نیست"}
              {products.amount != -1 && (
            ...
            <div className="w-full flex flex-row justify-between items-center">
              <div className="flex flex-row justify-start items-center gap-3">
                <span className="size-9 bg-gray-100 text-iconSecondaryColor rounded-full flex justify-center items-center">
                  <svg
              ...
              <div className="flex flex-row justify-start items-center">
                {[...Array(Number(5) - products.rating)].map((star) => (
                  <>
                    <svg
                      xmlns="http://www.w3.org/2000/svg"
                      fill="none"
                ...
                {[...Array(products.rating)].map((star) => (
                  <>
                    <svg
                      xmlns="http://www.w3.org/2000/svg"
                      fill="none"
